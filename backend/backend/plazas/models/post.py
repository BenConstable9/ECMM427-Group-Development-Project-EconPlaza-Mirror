...
class Post(models.Model):
    ...
    permissions = models.TextField("Post's Permissions which is a serialised object", blank=True)

    reactions = models.TextField("Post's Reactions which is a serialised object (Computed)", blank=True)
