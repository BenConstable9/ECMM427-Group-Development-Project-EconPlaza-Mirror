...
class UserSerializerTest(APITestCase):
    def setUp(self):
        ...
        self.user_1 = User.objects.create(
            username="user_1", first_name="Test", last_name="User", email="admin@test.com", is_staff=False)
    ...
    def test_contains_expected_fields(self):
        ...
        self.assertEqual(set(data.keys()), set(
            ["id", "url", "username", "email", "verified", "is_staff", "first_name", "last_name", "date_joined"]))
