...
class UserViewsetTest(APITestCase):
    ...
    def test_get_user(self):
        ...
        response = self.client.get('/accounts/users/{}/'.format(self.user_1.id))
    ...
    def test_delete_user(self):
        ...
        # Set the delete type
        response = self.client.delete('/accounts/users/{}/'.format(self.user_1.id))

        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)

    def test_delete_user_unauth(self):
        """Test we get a HTTP 403 response when attempting to delete data and we aren't authorised."""
    ...
    def test_put_user(self):
        ...
        response = self.client.put('/accounts/users/{}/'.format(self.user_1.id), payload)
    ...
    def test_post_user(self):
        ...
        response = self.client.post('/accounts/users/', payload)
