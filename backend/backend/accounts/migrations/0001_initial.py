    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "verified",
                    models.BooleanField(default=0, verbose_name="User's Verified Flag"),
                ),
                (
                    "banned",
                    models.BooleanField(default=0, verbose_name="User's Banned Flag"),
                ),
                (
                    "twitter_oauth",
                    models.CharField(
                        max_length=16, verbose_name="User's Twitter OAuth"
                    ),
                ),
                (
                    "created_at",
