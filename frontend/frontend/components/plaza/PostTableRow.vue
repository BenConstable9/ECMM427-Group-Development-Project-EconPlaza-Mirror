    ...
    <div class="flex flex-1 flex-col space-y-1">
      ...
      <p class="flex space-x-1">
        <span class="text-sm text-gray-700"
          >By
          <a class="font-semibold hover:underline" href="#">LloydTao</a></span
        >
        <span class="text-sm text-gray-700 font-semibold">&middot;</span>
        <span class="text-sm text-gray-700">Posted {{ rand }} hours ago</span>
      </p>
    </div>
